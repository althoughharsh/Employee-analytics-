    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="bg-gradient-to-r from-purple-500 to-pink-500 px-6 py-8 text-white text-center">
          ...
          <p className="text-purple-100 mt-2">Add an employee to the AI-powered HR platform</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-slate-50 focus:bg-white"
            ...
            <div>
              ...
              <textarea
                ...
                required
                rows="3"
                className="w-full px-4 py-2.5 border border-slate-300 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all bg-slate-50 focus:bg-white resize-none"
                onChange={handleChange}
            ...
            <div className="pt-4 flex justify-end gap-4 border-t border-slate-100">
              ...
              <button
                type="submit"
                className="px-6 py-2.5 bg-gradient-to-r from-purple-500 to-pink-500 hover:shadow-lg hover:shadow-purple-300 text-white font-semibold rounded-xl transition-all flex items-center gap-2"
              >
