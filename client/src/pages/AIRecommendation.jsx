...
const AIRecommendation = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      <div className="bg-gradient-to-r from-cyan-500 via-teal-500 to-green-600 rounded-3xl p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
        <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-white opacity-10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-0 -ml-16 -mb-16 w-48 h-48 bg-yellow-400 opacity-20 rounded-full blur-2xl"></div>
        
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="bg-white/20 p-2 rounded-xl backdrop-blur-sm">
                <BrainCircuit size={28} className="text-cyan-100" />
              </div>
              <span className="uppercase tracking-widest text-sm font-semibold text-cyan-100">AI Powered Insights</span>
            </div>
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
              Smart Employee <br />Recommendations
            </h1>
            <p className="text-cyan-50 max-w-xl text-lg">
          ...
          <button
            ...
            disabled={loading}
            className="shrink-0 bg-white text-teal-700 font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center gap-2 disabled:opacity-70 disabled:hover:scale-100"
          >
            {loading ? (
              <>
